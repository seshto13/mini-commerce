...
const Landing = () => {
  return (
    <div className="w-full h-screen px-4 my-4">
      <div className="w-full h-screen bg-[url('/assets/images/bgimage11.jpg')] bg-cover bg-center flex items-center  justify-center bg-transparent bg-opacity">
        <div className=" text-center ">
          <Bounce>
            {" "}
            <p
              className={`text-[50px] lg:px-52 font-medium ${playfair.className}`}
            >
